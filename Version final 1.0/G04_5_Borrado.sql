...
drop function if exists trfn_g04_ejecucionOrdenCompra();
drop function if exists trfn_g04_ejecucionOrdenVenta();
...
drop procedure if exists pr_g04_insertOrdenes(mercadoVar varchar(20),moneda_oVar varchar(10) ,moneda_dVar varchar(10),idVar bigint,cantOrdenes integer);
...
drop function if exists trfn_g04_calculoSuma(indice integer,mercadoVar varchar(20),tipoVar char(10),orden varchar(4));
drop function if exists trfn_g04_calculaHastaDondeSumar(cantASuperar numeric(20,10),mercadoVar varchar(20),tipoVar char(10), orden varchar(4));
drop function if exists trfn_g04_calculaTotalCrypto(mercadoVar varchar(20),tipoVar char(10));
...
alter table G04_ComposicionOrden drop constraint FK_G04_CompOp_Op_o;
alter table G04_ComposicionOrden drop constraint FK_G04_CompOp_Op_d;
alter table G04_Movimiento drop constraint FK_G04_Movimiento_Billetera;
alter table G04_Billetera drop constraint FK_G04_Billetera_Usuario;
alter table G04_Billetera drop constraint FK_G04_Billetera_Moneda;
alter table G04_Orden drop constraint FK_G04_Operacion_Usuario;
alter table G04_Orden drop constraint FK_G04_Operacion_Mercado;
alter table G04_Usuario drop constraint FK_G04_Usuario_Pais;
alter table G04_RelMoneda drop constraint FK_G04_RelMoneda_Monedaf;
alter table G04_RelMoneda drop constraint FK_G04_RelMoneda_Moneda;
alter table G04_Mercado drop constraint FK_G04_mercado_moneda_o;
alter table G04_Mercado drop constraint FK_G04_mercado_moneda_d;

alter table G04_ComposicionOrden drop constraint PK_G04_ComposicionOrden;
alter table G04_Movimiento drop constraint PK_G04_Movimiento;
alter table G04_Billetera drop constraint PK_G04_Billetera;
alter table G04_Orden drop constraint PK_G04_Orden;
alter table G04_Usuario drop constraint PK_G04_Usuario;
alter table G04_Pais drop constraint PK_G04_Pais;
alter table G04_RelMoneda drop constraint PK_G04_RelMoneda;
alter table G04_Mercado drop constraint PK_G04_Mercado;
alter table G04_Moneda drop constraint PK_G04_Moneda;

drop table G04_ComposicionOrden;
drop table G04_Movimiento;
drop table G04_Billetera;
drop table G04_Orden;
drop table G04_Usuario;
drop table G04_Pais;
drop table G04_RelMoneda;
drop table G04_Mercado;
drop table G04_Moneda;