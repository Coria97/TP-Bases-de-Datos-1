...
-- Funcion que ejecuta una orden de compra, y si la de venta que se desea ejecutar es demasiado grande, la divide y genera una nueva con el remanente
...
-- Funcion que ejecuta una orden de venta, y si la de compra que se desea ejecutar es demasiado grande, la divide y genera una nueva con el remanente
