    ...
    begin
        loop
            exit when i > cantOrdenes;
                ...
                if (i%2 = 0) then
                    update g04_billetera set saldo = randomVar where id_usuario = i and moneda= moneda_dVar;
                    insert into g04_orden values (idVar + i, mercadoVar, i ,'compra', current_date, NULL, random() * 10, random() * randomVar, 'activo');
                else
                    update g04_billetera set saldo = randomVar where id_usuario = i and moneda= moneda_oVar;
